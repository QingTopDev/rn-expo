...
import { Platform, StyleSheet, View, Text, Linking, TextInput, ImageBackground, Image, SafeAreaView, Dimensions, Animated, Keyboard, UIManager, StatusBar, TouchableOpacity } from 'react-native';
...
class login extends Component {
    ...
    async componentDidMount() {
        ...
        if (accessToken) this.props.navigation.navigate('Filtro')
    }
