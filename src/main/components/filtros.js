...
import Logo from "../../assets/images/arrow-down-circle.svg";
...
export default class SectionListBasics extends Component {
              ...
              return (
                ...
                >
                  ...
                  <Icon
                    ...
                    size={20}
                    color={
                      item.value == this.state.tipojoya.value
                        ? "#AD7A32"
                        : "#EEE"
                    }
                  />
              ...
              return (
                ...
                >
                  ...
                  <Icon
                    ...
                    size={20}
                    color={
                      item.value == this.state.metal.value ? "#AD7A32" : "#EEE"
                    }
                  />
                </TouchableOpacity>
              );
              ...
              return (
                ...
                >
                  ...
                  <Icon
                    ...
                    size={20}
                    color={
                      item.value == this.state.gema.value ? "#AD7A32" : "#EEE"
                    }
                  />
                </TouchableOpacity>
              );
  ...
  render() {
    return (
      <ImageBackground
        source={require("../../../src/assets/images/104.jpg")}
        style={{ flex: 1 }}
      >
              ...
              <CheckBox
                containerStyle={
                  Platform.isPad == true
                    ...
                    : { with: wp("80%"), backgroundColor: "tranparent" }
                }
